      ...
      privateDnsZoneGroupConfigs: [
        {
          ...
          privateDnsZoneResourceId: resourceId('Microsoft.Network/privateDnsZones', blobPrivateDNSZoneName)
        }
      ]
    }
  }
  dependsOn: [privateDnsZoneBlobDeployment]
}
      ...
      privateDnsZoneGroupConfigs: [
        {
          ...
          privateDnsZoneResourceId: resourceId('Microsoft.Network/privateDnsZones', queuePrivateDNSZoneName)
        }
      ]
    }
  }
  dependsOn: [privateDnsZoneQueueDeployment]
}
      ...
      privateDnsZoneGroupConfigs: [
        {
          ...
          privateDnsZoneResourceId: resourceId('Microsoft.Network/privateDnsZones', tablePrivateDNSZoneName)
        }
      ]
    }
  }
  dependsOn: [privateDnsZoneTableDeployment]
}
