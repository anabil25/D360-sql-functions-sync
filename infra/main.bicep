...
var resolvedVNetName = !empty(vNetName) ? vNetName : '${abbrs.networkVirtualNetworks}${resourceToken}'
...
module api './app/api.bicep' = {
  ...
  params: {
    ...
    virtualNetworkSubnetId: vnetEnabled ? resourceId(rg.name, 'Microsoft.Network/virtualNetworks/subnets', resolvedVNetName, appSubnetName) : ''
...
module storagePrivateEndpoint 'app/storage-PrivateEndpoint.bicep' = if (vnetEnabled) {
  ...
  params: {
    location: location
    tags: tags
    virtualNetworkName: resolvedVNetName
